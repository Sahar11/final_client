  ...
  <!-- Main wrapper-screen --> */}
      ...
      <!-- Header-middle starts--> */}
          <div className="header-middle flex pad-lft-rth no-flex">
            ...
            <div id="hamburger-icon" className="nav-menu">
                ...
                <div className="abou-us-info flex">
                  ...
                  <div>
                    <p>
                      ...
                      efficient, reliable and high-quality services. As a
                      trusted partner supporting patients, healthcare providers,
                      corporate customers and entire provincial healthcare
                      systems, we are continually harnessing our medical
                      expertise to build the best test offering while investing
                      in technology to transform the delivery of health care.
                    </p>
                  </div>
                </div>
              </div>
